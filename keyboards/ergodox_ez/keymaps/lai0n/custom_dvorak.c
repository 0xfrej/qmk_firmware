...
KC_VOLD, KC_MUTE,    RGB_TOG, XXXXXXX, KC_MAIL, KC_FIND, KC_WWW_REFRESH,      KC_WWW_FAVORITES, KC_MYCM, KC_CALC, XXXXXXX, RGB_MOD, RGB_M_P, KC_VOLU,
...
RGB_HUD, XXXXXXX,    XXXXXXX, _______,  KC_F23,  KC_F21,    KC_WWW_BACK,      KC_WWW_FORWARD  , KC_F22 , KC_F24 , _______, XXXXXXX, XXXXXXX, RGB_HUI,
RGB_VAD, KC_CLCK, KC_PSCREEN, XXXXXXX, XXXXXXX,                                                          KC_PWR , XXXXXXX, KC_SLEP, KC_WAKE, RGB_VAI,
...
XXXXXXX, HYPR(KC_F21), HYPR(KC_F22), HYPR(KC_F23), HYPR(KC_F24),                                                        XXXXXXX   , XXXXXXX  , XXXXXXX   , XXXXXXX, XXXXXXX,
